...
```
### 🔷 **Registro de Aulas** | Redes de Computadores 
...
### 🔷Rastreamento de Presença | Calem - 01º Período
...
views:
  - name: 
    from: '("Estudos/UTFPR - Eng. de Software/UTFPR - Eng. de Software - 2024.02 - 2º Período/UTFPR - Eng. de Software - Disciplinas/ES42E - Calem/Anotações")'
    orientation: landscape
    where: 'file.frontmatter.Tipo = "Anotação"'
```

## 💙 **Avaliações** | Calem - 01º Período
```dataviewjs
// Obtenha o nome do arquivo atual
let nomeArquivoAtual = dv.current().file.name;
let notaManual;
