...
A Separação deve acontecer dentro da Pasta 'Store' usando 'Modules', onde estarão também os tipos de ações em 'types.js' e o arquivo de combinação de todos os Reducers em 'rootReducer.js'. Dentro da Pasta 'Modules' estarão os Módulos. Dentro da Pasta de cada Módulo estarão 3 arquivos: 'actions.js' - 'reducer.js' - 'middleware.js'. 
