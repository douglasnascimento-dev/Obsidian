...
![[Gerenciamento de Projeto de Software.svg|banner]]
> [!banner-icon] :LiBookMarked: ES47D
...
let pages = dv.pages()
    .where(p => p.file.path.includes('Estudos/UTFPR - Eng. de Software/UTFPR - Eng. de Software - 2025.01 - 3º Período/UTFPR - Eng. de Software - Disciplinas/ES47D - Gerenciamento de Projeto de Software/Atividades'));
...
// Obtenha todas as notas dentro do diretório especificado
let pages = dv.pages()
    .where(p => p.file.path.includes('Estudos/UTFPR - Eng. de Software/UTFPR - Eng. de Software - 2025.01 - 3º Período/UTFPR - Eng. de Software - Disciplinas/ES47D - Gerenciamento de Projeto de Software/Anotações'));
...
# :LiPieChart: **Avaliações** | Gerenciamento de Projeto de Software
...
let pages = dv.pages()
    .where(p => p.file.path.includes('Estudos/UTFPR - Eng. de Software/UTFPR - Eng. de Software - 2025.01 - 3º Período/UTFPR - Eng. de Software - Disciplinas/ES47D - Gerenciamento de Projeto de Software/Avaliações'));
