...
![[JSTS.png|banner]]
> [!banner-icon] :LiBookMarked: Módulo 13

# :LiClipboard: **Atividades** | JS & TS - Deploy da Aplicação
```dataviewjs
...
```
# :LiBook: **Anotações** | JS & TS - Deploy da Aplicação

### [[JS & TS - 13.01 - CRUD - Usuários]]

Durante essas anotações, é apresentada as anotações relacionadas ao processo de CRUD dos Usuários, a criação, a atualização, a leitura e a exclusão de Usuários, como a criação de controllers, models e middlewares.

[[JS & TS - 13.02 - Tokens]]

Durante essas anotações, é apresenta as anotações relacionadas ao processo de utilização de Tokens para Usuários, como o processo de configuração, e a criação de Tokens para os Usuários. 